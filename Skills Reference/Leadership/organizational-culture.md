...
- **Artefacts** — visible structures, behaviours, and symbols (above the waterline)
- **Espoused Values** — stated strategies, goals, and philosophies (at the waterline)
- **Basic Assumptions** — unconscious, taken-for-granted beliefs that actually drive behaviour (deep underwater)

Culture change initiatives frequently fail because they target artefacts while leaving basic assumptions intact.

## Mental Model

The diagnostic question is: *where do espoused values and actual behaviour diverge?* That gap is the location of the underlying basic assumptions. If a company espouses "we celebrate failure" but every post-mortem ends in blame, the basic assumption is that failure is career-threatening. No amount of redecorating the artefact layer will close that gap.
