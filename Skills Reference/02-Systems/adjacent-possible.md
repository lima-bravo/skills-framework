...
→ [**Analogical Reasoning**](../01-General-Thinking/analogical-reasoning.md) — analogical reasoning expands the adjacent possible by making solutions developed in distant domains available to import, effectively opening new doors without passing through all intermediate rooms.
→ [**Disruptive Innovation**](../07-Business/disruptive-innovation.md) — disruption often begins at the adjacent possible of entrants, who are positioned (by lower cost structures and different customer focus) adjacent to innovations incumbents cannot reach.
→ [**Compounding**](../08-Mathematics/compounding.md) — each step through the adjacent possible compounds: entering a new room doesn't just solve today's problem, it opens new doors unavailable from the previous room. The value of early steps is partly the future steps they make accessible.
