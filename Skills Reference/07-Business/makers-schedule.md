...
## Connections
→ [**Deep Work / Cognitive Capacity**](../10-Learning/deep-work.md) — the scheduling structure that preserves or destroys deep work time
→ [**Bottlenecks**](../02-Systems/bottlenecks.md) — fragmented schedules make attention the binding bottleneck
→ [**Activation Energy**](../04-Physics-and-Chemistry/activation-energy.md) — every interruption resets the cost of re-entering deep focus
→ [**Friction**](../04-Physics-and-Chemistry/friction.md) — scattered meetings are a structural source of compounding cognitive friction
→ [**Incentives**](../05-Psychology/incentives.md) — organizations reward responsiveness; protecting maker time requires counteracting this
→ [**Feedback Loops**](../02-Systems/feedback-loops.md) — fragmentation → lower output → more status meetings → more fragmentation
→ [**Conway's Law**](../02-Systems/conways-law.md) — org communication structures determine scheduling norms as a structural output
