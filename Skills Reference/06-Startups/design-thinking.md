...
→ [**Divergent and Convergent Thinking**](../01-General-Thinking/divergent-and-convergent-thinking.md) — design thinking is structured around alternating divergent phases (empathy, ideation) and convergent phases (problem definition, prototype selection, insight synthesis).
→ [**Assumption Mapping**](../07-Business/assumption-mapping.md) — design thinking's prototyping stage is most productive when combined with assumption mapping: the prototype tests the highest-priority assumption explicitly.
