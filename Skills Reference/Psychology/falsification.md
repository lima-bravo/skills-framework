...
Popper developed this as a demarcation criterion — a way of distinguishing science from pseudo-science — but the practical principle extends far beyond methodology. In everyday reasoning, falsification is the discipline of actively seeking disconfirming evidence rather than merely accumulating confirmatory evidence. It is the corrective practice to Confirmation Bias: where confirmation bias describes the failure, falsification is the habit that prevents it.
