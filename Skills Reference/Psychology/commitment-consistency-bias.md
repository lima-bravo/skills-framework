...
Robert Cialdini identified this as one of the core principles of influence in *Influence* (1984), but its roots run deeper into cognitive dissonance theory (Festinger, 1957): holding two contradictory beliefs simultaneously is psychologically uncomfortable, and the easiest resolution is to suppress or discount the new, contradicting belief rather than revise the established one. The more public the commitment, the more resources invested, and the more central the belief to our identity, the stronger the pull toward consistency.
...
The CTO acknowledges the briefing privately but doesn't act. The platform has been mentioned in investor materials as a strategic asset. The engineering team is proud of the work. Reversing would require explaining the change to the board, re-allocating six engineers, and implicitly acknowledging that 18 months of investment should have been spent differently. The consistency pull is enormous.

The result: the platform ships, is maintained for two years at significant cost, never achieves the anticipated differentiation, and is quietly decommissioned — at total cost significantly higher than an earlier exit would have required.
