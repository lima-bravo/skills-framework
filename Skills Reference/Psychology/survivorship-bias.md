...
The bias is pervasive because our data is almost always drawn from survivors. We study successful companies, living investors, published research, and prominent careers — all of which have already passed through a filter. The numerator (successes) is visible; the denominator (all attempts) is hidden.
...
A leadership team wants to understand what makes acquisitions succeed. They pull together a study of 15 acquisitions the company made over the past decade — all of which were eventually absorbed and contributed positively to revenue. They identify common factors: the acquired company was sub-50 people, the founding team stayed on for at least two years, and integration was handled locally rather than centrally. They conclude these are the success factors.
