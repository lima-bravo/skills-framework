...
In 2006, major financial institutions had risk models calibrated to decades of housing price data showing that US housing prices had never declined nationally. The models assigned near-zero probability to a national decline. This was not laziness — it was the application of historical data using normal distribution assumptions in a domain (correlated mortgage exposure, interconnected leverage) that was structurally Extremistan. When the tail event occurred in 2007–2008, it was not just unexpected; the institutions had actively sized positions to exploit the "safe" end of the distribution. The Black Swan was not just a surprise — it was a catastrophe because the risk model had inverted: the "safe" position was the maximally fragile one.
