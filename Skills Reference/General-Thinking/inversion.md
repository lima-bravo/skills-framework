...
connections:
  ...
  - id: 55
    rationale: "inversion is the structural antidote to confirmation bias: you are explicitly seeking disconfirmation."
  - id: 24
    rationale: inversion identifies what can go wrong; margin of safety quantifies how much buffer to hold against it.
  - id: 0
    rationale: first principles builds up from what is true; inversion works down from what would make the answer wrong. Run both together.
  - id: 10
    rationale: "the pre-mortem is inversion applied to a plan: assume it has already failed, then work backward to the causes you can prevent now."
  - id: 8
    rationale: inversion is one of the most powerful thought-experiment structures; the pre-mortem is the most common organizational form of it.
  - id: 15
    rationale: 'the RMF is inversion applied to life decisions: instead of asking "what should I choose?", ask "which choice would I regret more at 80?"'
  - id: 107
    rationale: "inversion is a structured divergent technique: approaching the problem from the opposite direction breaks conventional attractors and generates non-obvious possibilities."
  - id: 52
    rationale: framing a decision in loss terms (what you risk losing) is inversion applied to motivation; loss aversion makes this framing more viscerally compelling than gain framing.
  - id: 53
...
references:
  - title: "Poor Charlie's Almanack: The Wit and Wisdom of Charles T. Munger"
    ...
    supports: the primary source for inversion as a practical thinking discipline.
  - title: "The Great Mental Models Vol. 1: General Thinking Concepts"
    authorYear: Shane Parrish & Rhiannon Beaubien (2019)
    supports: includes inversion as a core mental model with worked examples.
---
