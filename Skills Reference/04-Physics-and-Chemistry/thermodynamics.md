...
→ [**Feedback Loops**](../02-Systems/feedback-loops.md) — balancing feedback loops are the mechanisms that fight entropy; they require energy to operate.
→ [**Margin of Safety**](../02-Systems/margin-of-safety.md) — the second law suggests things will degrade; margin of safety is the buffer for that degradation.
→ [**Churn**](../02-Systems/churn.md) — churn is entropy in a customer base; it is the natural tendency absent active retention investment.
