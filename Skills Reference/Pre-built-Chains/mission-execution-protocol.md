...
The three failure modes it directly addresses:
- **Vague briefs** — leaders communicate task lists, not intent; teams execute the letter of the brief rather than its spirit, and cannot adapt when the plan breaks
- **Plans that don't survive contact with reality** — misaligned assumptions embedded in plans are not surfaced before resources are committed
- **No structured reflection** — learning from each project does not compound because it is never captured
...
**Skipping the Confirmation Brief because "the team is experienced."** Experience reduces the probability of comprehension gaps; it does not eliminate them. The Confirmation Brief is most valuable precisely when teams are confident they understood.

**The Back Brief becoming an approval ritual.** If the leader uses the Back Brief to redesign the plan rather than flag assumptions, the team learns to present the plan they think the leader wants to see. The Back Brief produces defensive presenting, not honest alignment.

**Calling a Tactical Pause too late.** The longer a team waits to call a pause, the more sunk cost has accumulated and the harder it is to change course. Early pauses are cheap; late ones are expensive.

**Running the AAR two weeks after delivery.** Memory degrades, narratives smooth, and the emotional context that makes honest reflection possible has dissipated. The AAR's value is 80% in the immediacy. Two weeks later, it is a retrospective — useful, but not the same thing.

**Completing Step 6 and not writing it down.** An unwritten AAR benefits only the people in the room. A written, searchable AAR compounds across teams and over time.

---

## Skills in This Chain

- **Leader's Intent** — the structured three-part brief
- **Brief-Back Protocols** — Confirmation Brief and Back Brief
- **Mission Command** — the philosophy that makes the protocol coherent
- **Pre-mortem** — complement to the Back Brief for high-stakes projects
- **OODA Loop** — the decision cycle the Tactical Pause triggers
