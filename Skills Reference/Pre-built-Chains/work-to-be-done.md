...
A single **Work to Be Done** artifact containing:

1. **Outcome** (one paragraph, testable)
2. **Diagnosis and guiding policy** (kernel)
3. **Theory of change** (diagram or table + ranked assumptions)
4. **MECE work tree** (with owners where known)
5. **Prioritized work queue** (now / next / never) with kill criteria
6. **Flow sketch** (critical path, bottleneck hypothesis, key dependencies)
