...
This chain produces a prioritised diagnosis — which mechanism is primary, which are downstream effects, and therefore where intervention has leverage. It does not produce a remediation plan; that is the work of the Transformation Chain and the Org Design for Flow Diagnostic (#169), which follow from it.

**Do not skip steps.** The mechanisms interact and compound. Identifying one active mechanism without checking the others leaves the diagnosis partial and the subsequent intervention prone to Cobra Effect dynamics — fixing the presenting symptom while the undiagnosed root cause absorbs or undermines the fix.
...
The seven steps produce a map of active degradation mechanisms. The synthesis task is to identify the **primary mechanism** — the one that, if addressed, would most reduce the others — and the **compounding sequence** — how the mechanisms are reinforcing each other.

**Common primary mechanisms and what they imply:**

- **Drift to Failure as primary:** The organisation has lost its feedback loops and no longer registers deterioration as deterioration. Intervention priority: restore explicit standards and measurement before any other change — otherwise you cannot tell whether subsequent interventions are working.

- **Dunbar's Number as primary:** The organisation has outgrown its coordination model. Peter Principle accumulation and Parkinson expansion are secondary effects — they fill the vacuum left by failing relational coordination. Intervention priority: redesign the coordination architecture first; management quality and process efficiency improvements will have limited effect until the structural coordination problem is solved.

- **Peter Principle as primary:** The management layer is a binding constraint. Parkinson expansion and Cobra Effect interventions are being produced and perpetuated by management that lacks the capability to challenge them. Intervention priority: address management capability and composition before launching new programmes, which will otherwise be poorly designed and weakly held accountable.

- **Goodhart's Law / Cobra Effect as primary:** The organisation is actively investing in its own degradation through misaligned programmes. Intervention priority: stop the most counterproductive interventions before adding new ones — this is the hardest political step, and the most valuable.

- **Conway's Law as primary:** Structure is the constraint. People and programmes are working as well as the structure allows; changing them without changing the structure produces temporary improvements that revert. Intervention priority: structural redesign, including the system architecture that the structure mirrors.

- **Principal–Agent as primary:** Incentive misalignment is driving the behaviour that sustains all other mechanisms. Intervention priority: redesign the incentive structure — compensation, accountability, promotion criteria, and consequence frameworks — before cultural or process interventions, which will be undermined by the incentive structure they operate within.

**Key signals that the diagnosis is complete:** you can name the primary mechanism and explain why the others are downstream of it; you can identify at least one specific decision or behaviour that is individually rational for the people making it but collectively degrading; you can name the intervention that is currently most actively sustaining the problem it was designed to solve.

---

## What Comes Next

This chain produces a diagnosis, not a remediation plan. The outputs feed directly into:

- [**Transformation Chain**](transformation.md) (#130) — if the diagnosis indicates systemic transformation is required
- [**Org Design for Flow Diagnostic**](org-design-for-flow.md) (#169) — if Conway's Law and coordination structure are the primary mechanism
- [**Innovation Capability Diagnostic**](innovation-capability-diagnostic.md) (#177) — if the Cobra Effect is primarily operating through innovation and change programmes
