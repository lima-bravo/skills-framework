...
- *A Guide to the Project Management Body of Knowledge (PMBOK Guide)*, 7th ed. — Project Management Institute (2021) — the standard project management reference; formalises RACI as the responsibility assignment matrix within project governance.
- *Organization Design: Engaging with Change* — Naomi Stanford (Routledge, 2nd ed., 2013) — practitioner treatment of accountability structures, role clarity, and how responsibility assignment integrates with broader organisational design.
