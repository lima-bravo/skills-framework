...
The critical distinction from conventional forecasting: forecasting tries to predict the single most likely future; scenario planning acknowledges genuine uncertainty and asks *what kinds of futures are plausible*, then builds strategy resilient across those possibilities.
...
**Originators:** Pierre Wack and Ted Newland (Shell, 1970s); Herman Kahn (RAND); Peter Schwartz codified for general business use.
