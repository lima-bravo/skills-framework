...
→ [**Margin of Safety**](../02-Systems/margin-of-safety.md) — the direct structural remedy: build buffer proportional to underestimation tendency
→ [**Pre-mortem**](../01-General-Thinking/pre-mortem.md) — the most effective tactical intervention against the planning fallacy
→ [**Probabilistic Thinking**](../01-General-Thinking/probabilistic-thinking.md) — thinking in distributions is the cognitive toolkit of the outside view
→ [**Second-Order Effects**](../01-General-Thinking/second-order-effects.md) — cascading dependencies and rework are the most commonly ignored planning costs
→ [**Deep Work / Cognitive Capacity**](../10-Learning/deep-work.md) — plans assuming 8 productive hours per day compound the planning fallacy
→ [**Regression to the Mean**](../08-Mathematics/regression-to-the-mean.md) — exceptional early velocity regresses; plans that extrapolate it are doubly wrong
