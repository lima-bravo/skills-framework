...
## Connections
→ [**Deep Work / Cognitive Capacity**](../10-Learning/deep-work.md) — foundational capacity metric: realistic deep work hours, not calendar hours
→ [**Maker's Schedule vs. Manager's Schedule**](../07-Business/makers-schedule.md) — fragmentation adjustment applied in Step 2
→ [**Planning Fallacy**](../05-Psychology/planning-fallacy.md) — demand-side correction applied in Step 3
→ [**Bottlenecks**](../02-Systems/bottlenecks.md) — binding constraint identification in Step 4
→ [**Debt**](../03-Economics/debt.md) — pre-existing capacity tax accounted for in Step 5
→ [**Second-Order Effects**](../01-General-Thinking/second-order-effects.md) — feedback loop modeled in Step 6
→ [**Margin of Safety**](../02-Systems/margin-of-safety.md) — final buffer applied in Step 7
→ [**Incentives**](../05-Psychology/incentives.md) — process integrity check in Step 8
