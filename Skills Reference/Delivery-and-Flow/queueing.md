---
id: 135
name: Queueing & Wait Time
category: Delivery & Flow
cardType: standard
tagline: Most delay is waiting, not working
connections:
  - id: 131
    rationale: Little's Law is the steady-state arithmetic; queueing theory explains the dynamics.
  - id: 133
    rationale: flow efficiency is the operational metric that surfaces queueing pathology.
  - id: 140
    rationale: variability is the multiplier on queueing wait time.
  - id: 136
    rationale: large batches are a primary source of variability.
  - id: 18
