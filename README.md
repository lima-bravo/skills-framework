...
- Search and category filters across **267 skills**
- Expandable skill modals with cross-links
- **Sources & References** panel (**387** sources)
...
The deck's **267 reference cards** are not exported 1:1. `npm run build:cowork` generates **59 procedural skills** in seven plugins under `plugins/`:
...
Skills Reference/
  ...
  skills-manifest.json       # Canonical registry: ids, categories, refs (267 skills)
