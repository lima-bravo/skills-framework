...
A mental-models framework with a publishable **reference website** (`docs/`), per-skill markdown deep-dives, a connection graph, and a [training guide](Skills%20Reference/training-guide.md). **279 skills** across **16 categories** (source of truth: `skills-manifest.json`).
...
- Search and category filters across **279 skills**
- Expandable skill modals with cross-links
- **Sources & References** panel (**409** sources)
...
The deck's **279 reference cards** are not exported 1:1. `npm run build:cowork` generates **59 procedural skills** in seven plugins under `plugins/`:
...
Skills Reference/
  ...
  skills-manifest.json       # Canonical registry: ids, categories, refs (279 skills)
