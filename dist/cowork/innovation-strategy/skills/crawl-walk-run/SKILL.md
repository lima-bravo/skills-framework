---
name: "crawl-walk-run"
description: "Stages a new initiative across three evidence gates — does it work at all (crawl), well enough (walk), with real economics (run). Use to de-risk innovation bets and prevent premature scaling."
metadata:
  framework-source: "Pre-built-Chains/crawl-walk-run.md"
  plugin: "innovation-strategy"
  version: "1.0.0"
  invocation: "manual"
---

> **Invocation:** Run only when the user explicitly requests this chain (e.g. `/crawl-walk-run`) or a matching high-stakes decision. Do not auto-invoke for general questions.
